...
RETURNING customer_order_id, order_id, order_date, customer_id, shipping_method_id
`
...
SELECT customer_order_id, order_id, order_date, customer_id, shipping_method_id FROM customer_order
